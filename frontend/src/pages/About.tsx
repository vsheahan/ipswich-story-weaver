      ...
      <div className="prose prose-sea font-serif text-gray-700 space-y-6">
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-3">
            ...
            <li>
              <strong>Ocean Conditions</strong> — Sea surface temperature, wave height and direction,
              and ocean color from NOAA CoastWatch satellite data
            </li>
            <li>
              <strong>Air Quality</strong> — PM2.5 and ozone levels from the EPA AirNow network
            </li>
            <li>
              <strong>Land & Vegetation</strong> — Drought conditions from the US Drought Monitor,
              snow cover from NOAA, and vegetation greenness from satellite imagery
            </li>
            <li>
              <strong>Night Sky</strong> — Visible planets and meteor shower activity calculated
              for Ipswich's coordinates
            </li>
            <li>
        ...
        <section className="text-sm text-gray-500 mt-8 pt-6 border-t border-sand-200">
          <p>
            ...
            tides from NOAA CO-OPS, bird sightings from eBird (Cornell Lab of Ornithology),
            river flow from USGS Water Resources, news from The Local News RSS feed,
            sea surface temperature and ocean color from NOAA CoastWatch ERDDAP,
            wave data from NOAA WaveWatch III, air quality from EPA AirNow,
            drought conditions from US Drought Monitor, snow cover from NOAA SNODAS,
            and planetary positions calculated with astronomy-engine.
          </p>
          <p className="mt-2">
